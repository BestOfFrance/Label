const data = require('./newShopDataPhone')
...
axios.all(dataArray.map(l => axios.get('https://api.yelp.com/v3/businesses/search/phone', {
  headers: {
    Authorization: `Bearer H1IcGJB65EqYA4wvHWt9zpO1HyiHxQ4_9zGBnQYtRRrcOFFvn-kOAEoEYWptsfL8Bd3T5MV9uGW0MqHe9LqdIFXO25worzkCIb74jOgVJnIsnYnYx`
},
  params: {
    phone: l.newNumber,
    locale: 'en_CA'
...
return l.title;
  ...
  .then(axios.spread(function (...res) {
    var file = fs.createWriteStream('arrayDataTen000useMePhone.js');
