const data = require('./newShopData')
const axios = require('axios');
const fs = require('fs');

// const terms = [{name: 'La Baguette et Compagnie', address: '1102 Davie Street Vancouver'}, 
// {name: 'Salade de Fruits Cafe', address: '1551 West 7th Avenue'},
// {name: 'Provence Marinaside', address: '1177 Marinaside Crescent'},
// {name: 'Le Crocodile Restaurant', address: '909 Burrard Street'}, 
// {name: 'Faubourg', address: '2156 W 41st Avenue'},
// {name: 'Faubourg', address: '769 Hornby Street'}]

// const getData = function(term) {
...
for (let i = 0; i <= 50; i++) {
  ...
  let state = (data[i].state).toString()
...
// console.log(dataArray.length, 'data array length')
...
// const newDataAray=[]
// axios.all(dataArray.map(l => axios.get('https://api.yelp.com/v3/businesses/search', {
//   headers: {
//     Authorization: `Bearer nxBY2qRdQtx6tQSmpDNElKsuUINdEi_aI_4RDjjvqs3lbzGmgMem__btNaNnT2ruHn28UmFMc-GSVXD6Q_ffREboy1bP4Po1S6AdGYXYx`
// },
//   params: {
//     term: l.terms.name,
//     location: l.terms.address,
//     limit: 1
