...
function createInquiryParamsConfig(email, message){
	const params = {
	  ...
	  Message: { /* required */
	    Body: { /* required */
	      Html: {
	        Data: generateHTMLInquiryEmail(email, message),
	        Charset: 'UTF-8'
	      },
	      // Text: {
	    ...
	    Subject: { /* required */
	      Data: 'Kangzeroos Boilerplate says hi ', /* required */
	      Charset: 'UTF-8'
	    }
	  },
	  ...
	  ReturnPath: 'lisa.cormier@bestoffrance.ca',
